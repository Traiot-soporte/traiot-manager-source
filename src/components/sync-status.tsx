...
export function SyncStatus() {
  ...
  return (
    <div
      ...
      title={connected ? 'Lectura privada desde Google Sheets.' : 'Datos simulados sin conexion al backend.'}
    >
      <Icon aria-hidden="true" className="size-4" />
      <span className="hidden sm:inline">{connected ? 'Conectado · solo lectura' : 'Demostracion · sin backend'}</span>
